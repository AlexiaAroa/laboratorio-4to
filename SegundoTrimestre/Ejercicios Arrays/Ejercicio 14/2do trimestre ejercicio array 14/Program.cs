using System;
//14.Se ingresan dos vectores de N componentes enteras. La computadora muestra el valor del producto escalar entre ambos. 
namespace _2do_trimestre_ejercicio_array_14
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //PRODUCTO______________________________________________________
            for (cont = 0; cont < i; cont++)
            {
            ...
            for (cont = 0; cont < i; cont++)
            {
                Console.WriteLine("El producto escalar entre {0} y {1} es {2}", vector[cont], vector2[cont], vector3[cont]);
            }
            Console.ReadKey();
        }
    }
